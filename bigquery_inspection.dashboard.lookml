- dashboard: bigquery_inspection
  ...
  - title: Avg Runtime
    name: Avg Runtime
    model: block_bq_optimization_new
  ...
  - title: Query Detail
    ...
    filters:
      bigquery_data_access_payload.method_name: google.cloud.bigquery.v2.JobService.InsertJob
      bigquery_data_access_payload.service_name: bigquery.googleapis.com
  ...
  - title: Queries Over Time
    ...
    fields: [bigquery_data_access.number_of_queries, bigquery_data_access_job_statistics.start_date,
      bigquery_data_access_query.query_text_selector]
    pivots: [bigquery_data_access_query.query_text_selector]
    fill_fields: [bigquery_data_access_query.query_text_selector]
    filters:
      bigquery_data_access_payload.method_name: ''
      bigquery_data_access_payload.service_name: bigquery.googleapis.com
    sorts: [bigquery_data_access_job_statistics.start_date, bigquery_data_access_query.query_text_selector]
    limit: 500
    column_limit: 50
    color_application:
      collection_id: b43731d5-dc87-4a8e-b807-635bef3948e7
